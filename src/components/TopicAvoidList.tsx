...
const TopicAvoidList: React.FC<TopicAvoidListProps> = ({
  topics,
  onRemove,
  newTopic,
  setNewTopic,
  ...
  return (
    <div className="space-y-2">
      <h3 className="text-sm font-medium">Topics to Avoid ({topics.length}/10)</h3>
